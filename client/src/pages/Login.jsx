        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-xl font-semibold text-slate-700 dark:text-slate-200">Welcome Back</h2>
                </div>
                ...
                <p className="mt-6 text-center text-slate-600 dark:text-slate-400 text-sm">
                    Don't have an account? <Link to="/register" className="text-primary hover:text-secondary font-medium transition-colors">Create one now</Link>
                </p>
            </motion.div>
        </div>
    );
